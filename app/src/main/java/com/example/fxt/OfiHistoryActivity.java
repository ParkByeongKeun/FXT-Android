...
public class OfiHistoryActivity extends MainAppcompatActivity implements XListView.IXListViewListener{
    ...
    private OfiDataAdapter spliceDataAdapter;
    ActionBar mTitle;
...
//            showAlertDialog("Would you like to share?");
        ...
        spliceDataAdapter = new OfiDataAdapter(mOFIDataBeanList, getApplicationContext());
        ...
        mTitle.setTitle("OFI History List");
    ...
    public void setDoc() {
        ...
        for(int i = 0; i < mOFIDataBeanList.size() ; i ++) {
            ...
            for(int j = 0 ; j < fileList.size() ; j ++) {
                ...
                String excelPath =  pathName[0]+"_"+pathTime +".xls";
                String pdfPath = pathName[0]+"_"+pathTime +".pdf";
...
//            getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_close);
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            if(!spliceDataAdapter.getCheckBox()) {
                Intent intent = new Intent(getApplicationContext(), FusionDetailActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable(BEAN, mOFIDataBeanList.get(position-1));
        ...
        custom_dialog.findViewById(R.id.btnPDF).setOnClickListener(v -> {
            ...
            for(int i = 0 ; i < checkedItems.size() ; i++) {
                if(checkedItems.valueAt(i)) {
                    ...
                    Uri path = FileProvider.getUriForFile(this, "com.example.fxt" + ".fileprovider", filelocation);
        ...
        custom_dialog.findViewById(R.id.btnExcel).setOnClickListener(v -> {
            ...
            for(int i = 0 ; i < checkedItems.size() ; i++) {
                if(checkedItems.valueAt(i)) {
                    ...
                    String[] pathName = date.split(" ");
                    String pathTime= pathName[1].replaceAll(":", "_");
                    String pdfPath = pathName[0]+"_"+pathTime +".xls";
                    someFile = pdfPath;
                    File filelocation = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), someFile);
                    Uri path = FileProvider.getUriForFile(this, "com.example.fxt" + ".fileprovider", filelocation);
                    if(!filelocation.canRead()) {
