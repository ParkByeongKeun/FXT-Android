 ...
 * 基础dao类
 */
public abstract class BaseDaoSplice<T> {
    private Context mContext;               //上下文环境
    private MySQLiteOpenHelperSplice helper;      //数据库帮助类
    protected SQLiteDatabase db;            //数据库对象

    public BaseDaoSplice(Context context) {
        this.mContext = context;
        helper = new MySQLiteOpenHelperSplice(mContext);
