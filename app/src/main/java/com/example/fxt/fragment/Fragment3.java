package com.example.fxt.fragment;
...
import com.example.fxt.RestApi.ResponseGetVideoList;
import com.example.fxt.RestApi.RetrofitClient;
import com.example.fxt.TutorialActivity;
import com.example.fxt.utils.CustomVideoList;
import com.example.fxt.utils.StripHtml;
import com.example.fxt.utils.VideoListAdapter;
                ...
                public void onResponse(Call<ResponseGetVideoList> call, Response<ResponseGetVideoList> response) {
                    ...
                    if(body.getCode() == 0) {
                        ...
                        for(int i = 0 ; i < customApplication.getVideoList().size() ; i++) {
                            if(customApplication.getVideoList().get(i).getVoType().equals("3")) {
