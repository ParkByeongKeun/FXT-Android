 ...
 */
public class NiceCoreSpinner extends AppCompatTextView {
    ...
    private OnSpinnerCoreItemSelectedListener onSpinnerItemSelectedListener;
    ...
    public NiceCoreSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public NiceCoreSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NiceCoreSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            Log.d("yot132","select = " + data.get(position));
            ...
            if (onSpinnerItemSelectedListener != null) {
                onSpinnerItemSelectedListener.onItemSelected(NiceCoreSpinner.this, view, position, id);
            }
...
//            if(data.get(i).equals(customApplication.selectCore)) {
//                data.remove(i);
//            }
//        }
//
...
//            data.add(0,"144C");
//        }else {
//            String[] splCore = deleteData.split("C");
//            if(splCore.length <= 1) {
//                return;
//            }
//            data.add(Integer.parseInt(splCore[1]),customApplication.selectCore);
//        }
//        Log.d("yot132","remove = " + customApplication.selectCore);
    }
    ...
    public <T> void attachDataSource(@NonNull List<T> list, int textColor) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment);
        setAdapterInternal(adapter);
    }
    ...
    public OnSpinnerCoreItemSelectedListener getOnSpinnerItemSelectedListener() {
        return onSpinnerItemSelectedListener;
    }

    public void setOnSpinnerItemSelectedListener(OnSpinnerCoreItemSelectedListener onSpinnerItemSelectedListener) {
