...
import com.fiberfox.fxt.login.RegPushTokenRequest;
import com.fiberfox.fxt.login.RegPushTokenResponse;
import com.fiberfox.fxt.login.UnRegPushTokenRequest;
import com.fiberfox.fxt.login.UnRegPushTokenResponse;
...
public interface ApiService {
    ...
    @Multipart
    @POST("/detect")
    Call<ResponseEnclosure> enclosure(@Part MultipartBody.Part image);
