...
import com.fiberfox.fxt.GpsTracker;
...
import com.fiberfox.fxt.ble.device.splicer.bean.InfoBean;
import com.fiberfox.fxt.ble.device.splicer.bean.SpliceDataBean;
import com.fiberfox.fxt.utils.Byte2Image;
import com.fiberfox.fxt.utils.FileUtil;
 ...
 * 熔接机上报数据解析工具类
 */
public class USBSpliceDataParseUtil {
    ...
    public static InfoBean parseInfo(InfoBean spliceDataBean, BleResultBean bleDataBean) {
        ...
        String strJson = ByteUtil.getAsciiString(bleDataBean.getPayload(),0,bleDataBean.getPayload().length);
        if (strJson == null){
