 ...
 * 基础dao类
 */
public abstract class BaseDaoEnclosure<T> {
    private Context mContext;               //上下文环境
    private MySQLiteOpenHelperEnclosure helper;      //数据库帮助类
    protected SQLiteDatabase db;            //数据库对象

    public BaseDaoEnclosure(Context context) {
        this.mContext = context;
        helper = new MySQLiteOpenHelperEnclosure(mContext);
